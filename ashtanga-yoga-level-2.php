      ...
      <div class="container-fluid">
        <div class="row">
                <div class="col-xs-12 about_text">
                 <h2 class="heading1 colr_h">Ashtanga yoga level 2</h2>
          <h3 class="heading2">Syllabus</h3>
<p>
    <img src="assets/images/ashtanga_yl2_thumb.jpg" class="floating_thumbcntr" alt="iyengar" />
<ul class="list-group">
