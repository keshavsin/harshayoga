  ...
  <div class="table_wrapper bookingdetails">
    ...
    <div class="container-fluid" id="booking_container">
        ...
        if ($data->num_rows > 0) {
            ...
            $str .= '<thead><th>Id</th><th>Type</th><th>Name</th><th>Duration</th><th>Amount</th><th>Currency</th><th>Status</th><th>&nbsp;</th></thead><tbody>';
  ...
  <div class="modal-content">
      ...
      if (isset($_POST['update'])) {
          ...
          if ($post_type == '' or $post_title == '' or $post_duration == '' or $post_amount == '' or $post_currency == '' or $post_description == '') {
              ...
              $insert_query = "update product set type = '$post_type',title = '$post_title',duration = '$post_duration',duration_unit = '$post_duration_unit',amount = '$post_amount',currency = '$post_currency' , description = '$post_description' WHERE id='$post_updateid'";
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
              <select class="form-control form-shadow" name="type">
                ...
                <?php
                if ($row['type'] == "Teacher Training Course") {
                    echo '<option value="Teacher Training Course" selected="selected">Teacher Training Course</option>';
                } else {
                    echo '<option value="Teacher Training Course">Teacher Training Course</option>';
                }
                ?>
              </select>
            </div>
...
<div id="classmodal" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
	...
	require_once 'common/dbconf.php';
			...
			$insert_query = "insert into product(type,title,duration,duration_unit,amount,currency,description) values ('$post_type','$post_title','$post_duration','$post_duration_unit','$post_amount','$post_currency','$post_description')";
