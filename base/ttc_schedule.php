...
<div id="classmodaledit<?php echo $i; ?>" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
      ...
      if (isset($_POST['update'])) {
          ...
          if ($post_ttc_name == '' or $post_month == '' or $post_year == '' or $post_location == '' or $post_start_date == '' or $post_end_date == '' or $post_price == '') {
              echo "<script>alert('Any of the fields is empty')</script>";
              exit();
          } else {
              $insert_query = "update ttc_schedule set ttc_name = '$post_ttc_name',month = '$post_month',year = '$post_year',location = '$post_location', start_date = '$post_start_date',end_date = '$post_end_date', amount = '$post_price' WHERE id='$post_updateid'";
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control form-shadow" value="<?php echo $row["amount"] ?>" placeholder="Fees" id="amount" name="amount">
        </div>
      </div>
  ...
  <div class="modal-content">
      ...
      if (isset($_POST['submit'])) {
          ...
          if ($post_ttc_name == '' or $post_month == '' or $post_year == '' or $post_location == '' or $post_start_date == '' or $post_end_date == '' or $post_price == '') {
              ...
              $insert_query = "insert into ttc_schedule(ttc_name,month,year,location,start_date,end_date,amount) values ('$post_ttc_name','$post_month','$post_year','$post_location',
