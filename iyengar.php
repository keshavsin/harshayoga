      ...
      <div class="container-fluid">
        <div class="row">
                <div class="col-xs-12 about_text">
                 <h2 class="heading1 colr_h">Iyengar</h2>
          <h3 class="heading2">Of all that happens is said to have a source. Well, mine started with Guruji.</h3>
<p>
    <img src="assets/images/iyengar_thumb.jpg" class="floating_thumb" alt="iyengar" />
